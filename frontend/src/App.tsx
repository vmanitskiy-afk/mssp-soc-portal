...
import SocTenantsPage from './pages/SocTenantsPage';
import SocNkcki from './pages/SocNkcki';
  ...
  return (
    <Routes>
      ...
      >
        ...
        <Route path="/soc/tenants" element={<SocTenantsPage />} />
        <Route path="/soc/nkcki" element={<SocNkcki />} />
